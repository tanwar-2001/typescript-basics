...
var fetchPostData = function (path) { return __awaiter(_this, void 0, void 0, function () {
    var response;
...
var fetchUsersData = function (path) { return __awaiter(_this, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("http://example.com/".concat(path))];
...
var signin = function (cerdentials) {
